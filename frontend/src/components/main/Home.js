              ...
              >
                <div className="d-flex justify-content-center align-items-center h-100">
                  <div className="px-4 py-5 px-md-5 text-white text-center">
                    ...
                    <p className="mb-0" style={{ color: "hsl(210, 12%, 80%)" }}>
      ...
      <section className="mb-10">
        ...
        <div className="card mb-3">
          <div className="row g-0 d-flex align-items-center">
            <div className="col-lg-5 col-xl-4 d-none d-lg-flex">
              <img
            ...
            <div className="col-lg-6 col-xl-8">
              <div className="card-body p-md-5">
                <h2 className="fw-bold">
                  <span className="text-primary">Anna Doe</span>
                </h2>
                <p className="fw-bold">Graphic designer</p>
                <p className="text-muted mb-4">
                  Nunc tincidunt vulputate elit. Mauris varius purus malesuada
                  neque iaculis malesuada. Aenean gravida magna orci, non
                  efficitur est porta id. Donec magna diam.
